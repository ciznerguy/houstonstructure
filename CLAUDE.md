...
- **Bing (set up 2026-09-26, matters because ChatGPT runs on Bing)**:
  ...
  - **Known inconsistency to resolve**: hours read Sun-Sat 8 AM-8 PM in Google and Bing but Mon-Fri 8-5 (Sat by appointment) in `BUSINESS.hours`. Nobody has confirmed which is right.
