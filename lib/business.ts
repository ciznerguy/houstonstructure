    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "We walk through this tie-in detail, and the rest of the sequence, on an actual job in our [room addition case study](/projects/room-addition-case-study). We prevent it by matching the bearing depth of the existing foundation and connecting old to new with rebar dowels epoxied into the existing slab, so the two sections behave as one. On lots with particularly active clay we may recommend deeper footings or a different foundation approach altogether, and we say so before the concrete is ordered.",
        ],
        image: {
